...
TEST_F(Vendor_test, getCode) { EXPECT_EQ(vendor_ericsson_.getCode(), 193); }

TEST_F(Vendor_test, getName) { EXPECT_EQ(vendor_ericsson_.getName(), "Ericsson"); }

TEST_F(Vendor_test, isVendorSpecific) { EXPECT_TRUE(vendor_ericsson_.isVendorSpecific()); }
